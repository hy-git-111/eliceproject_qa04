...
class MyPage():
    ...
    def image_attach(self, driver):
        image_attach_btn = driver.find_element(By.XPATH, '//*[@id="modal-root"]/div/div[2]/section/form/div[1]/div/button')
    ...
    # 프로필 수정 완료 버튼 클릭
    def profile_setup_completed(self, driver):
        profile_setup_completed_btn = driver.find_element(By.XPATH, '//*[@id="modal-root"]/div/div[2]/section/form/button')
